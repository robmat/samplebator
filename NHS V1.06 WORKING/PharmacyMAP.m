...
- (void)viewDidLoad {
	...
	pharmacyLocations = [[NSArray alloc] initWithContentsOfFile:[[NSBundle mainBundle] 
														   pathForResource:@"PharmacyLeo" 
														   ofType:@"plist"]];
	
	
	for (NSDictionary *pharmacyDict in pharmacyLocations){
		MyAnnotation *annotation = [[MyAnnotation alloc] initWithDictionary: pharmacyDict];
...
- (MKAnnotationView *)mapView:(MKMapView *)mapView viewForAnnotation:(id <MKAnnotation>)annotation{
	...
	if (annotationView == nil){
		annotationView = [[[MKAnnotationView alloc] initWithAnnotation:annotation 
						  ...
						  autorelease];
		annotationView.image = [UIImage imageNamed:@"pharmicies menu.png"];
...
- (void)mapView:(MKMapView *)mapView annotationView:(MKAnnotationView *)view calloutAccessoryControlTapped:(UIControl *)control
{
	...
	int numElementos = [pharmacyLocations count] ; 
	...
	while ( (i < numElementos) && (!encontrado) ) {
		dict = [pharmacyLocations objectAtIndex:i] ;
	...
	[array writeToFile:[ self dataFilePathPharmacy ] atomically:YES ] ;
	[array release] ;
	...
	PharmacyMAPDetailsView * varPharmacyMAPDetailsView = [[PharmacyMAPDetailsView alloc] initWithNibName:@"PharmacyMAPDetailsView" bundle:nil ] ;
	[[self navigationController] pushViewController:varPharmacyMAPDetailsView animated:YES];
	[varPharmacyMAPDetailsView release] ;
