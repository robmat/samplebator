...
@implementation ViewEmergenciesMap
...
- (void)viewDidLoad {
	...
	EmergencyLocations = [dh getDataByCategory:@"ae"];
	[EmergencyLocations retain];
	//[EmergencyLocations addObjectsFromArray:[dh getDataByCategory:@"miu"]]; 
	
	for (NSDictionary * EmergencyDict in EmergencyLocations){
		MyAnnotation *annotation = [[MyAnnotation alloc] initWithDictionary: EmergencyDict];
...
- (MKAnnotationView *)mapView:(MKMapView *)mapView viewForAnnotation:(id <MKAnnotation>)annotation{
	...
	if (annotationView == nil){
		annotationView = [[[MKAnnotationView alloc] initWithAnnotation:annotation 
						  ...
						  autorelease];
		annotationView.image = [UIImage imageNamed:@"emergency menu.png"];
...
- (void)mapView:(MKMapView *)mapView annotationView:(MKAnnotationView *)view calloutAccessoryControlTapped:(UIControl *)control
{
	...
	int numElementos = [EmergencyLocations count] ; 
	...
	while ( (i < numElementos) && (!encontrado) ) {
		dict = [EmergencyLocations objectAtIndex:i] ;
	...
	[array writeToFile:[ self dataFilePathEmergency ] atomically:YES ] ;
	[array release] ;
	...
	viewEmergenciesMapDetailsView * varviewEmergenciesMapDetailsView = [[viewEmergenciesMapDetailsView alloc] initWithNibName:@"viewEmergenciesMapDetailsView" bundle:nil ] ;
	[[self navigationController] pushViewController:varviewEmergenciesMapDetailsView animated:YES];
	[varviewEmergenciesMapDetailsView release] ;
