...
@implementation dentalMAPDetailsView
...
-(IBAction)sendMail:(id)sender{
	...
	informacion	= [NSString stringWithFormat:@"Name of the dentist: %@. Ubication: %@ %@, %@. Telephone number: %@",labelNombre.text, labelAddress1.text, labelAddress1b.text, labelAddress2.text, labelPhone.text ] ;
	
	email = [NSString stringWithFormat: @"%@?Subject=NHS Yorkshire and Humber: Dentist informacion&body=%@", email, (@"%@", informacion)] ; 
...
- (void)viewDidLoad {
	...
	NSString * filePath = [self dataFilePathDental ] ;
