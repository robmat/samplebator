...
- (void)viewDidLoad {
	...
	hospitalLocations = [dh getDataByCategory:@"miu"];
	[hospitalLocations retain];
	[hospitalLocations addObjectsFromArray:[dh getDataByCategory:@"ae"]];
	[hospitalLocations addObjectsFromArray:[dh getDataByCategory:@"miu"]];
	
	
	for (NSDictionary * hospitalDict in hospitalLocations){
		MyAnnotation *annotation = [[MyAnnotation alloc] initWithDictionary: hospitalDict];
...
- (MKAnnotationView *)mapView:(MKMapView *)mapView viewForAnnotation:(id <MKAnnotation>)annotation{
	...
	if (annotationView == nil){
		annotationView = [[[MKAnnotationView alloc] initWithAnnotation:annotation 
						  ...
						  autorelease];
		annotationView.image = [UIImage imageNamed:@"hospital menu.png"];
...
- (void)mapView:(MKMapView *)mapView annotationView:(MKAnnotationView *)view calloutAccessoryControlTapped:(UIControl *)control
{
	...
	int numElementos = [hospitalLocations count] ; 
	...
	while ( (i < numElementos) && (!encontrado) ) {
		dict = [hospitalLocations objectAtIndex:i] ;
	...
	[array writeToFile:[ self dataFilePathHospital ] atomically:YES ] ;
	[array release] ;
	...
	hospitalMAPDetail * varhospitalMAPDetail = [[hospitalMAPDetail alloc] initWithNibName:@"hospitalMAPDetail" bundle:nil ] ;
	[[self navigationController] pushViewController:varhospitalMAPDetail animated:YES];
	[varhospitalMAPDetail release] ;
