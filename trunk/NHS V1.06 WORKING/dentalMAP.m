...
#import "DentalMapDetailsView.h"
#import "JSON.h"
#import "DentalMAP.h"

@implementation dentalMAP
...
-(NSString *) dataFilePathDental{
	...
	return [documentsDirectory stringByAppendingPathComponent:kFilenameDental ] ;
...
- (void)viewDidLoad {
	...
	dentalLocations = [[NSArray alloc] initWithContentsOfFile:[[NSBundle mainBundle] 
																 pathForResource:@"dentistLeo" 
																 ofType:@"plist"]];
	
	
	for (NSDictionary * dentalDict in dentalLocations){
		MyAnnotation *annotation = [[MyAnnotation alloc] initWithDictionary: dentalDict];
...
- (MKAnnotationView *)mapView:(MKMapView *)mapView viewForAnnotation:(id <MKAnnotation>)annotation{
	...
	if (annotationView == nil){
		annotationView = [[[MKAnnotationView alloc] initWithAnnotation:annotation 
						  ...
						  autorelease];
		annotationView.image = [UIImage imageNamed:@"dentist menu.png"];
...
- (void)mapView:(MKMapView *)mapView annotationView:(MKAnnotationView *)view calloutAccessoryControlTapped:(UIControl *)control
{
	...
	int numElementos = [dentalLocations count] ; 
	...
	while ( (i < numElementos) && (!encontrado) ) {
		dict = [dentalLocations objectAtIndex:i] ;
	...
	[array writeToFile:[ self dataFilePathDental ] atomically:YES ] ;
	[array release] ;
	...
	dentalMAPDetailsView * vardentalMAPDetailsView = [[dentalMAPDetailsView alloc] initWithNibName:@"dentalMAPDetailsView" bundle:nil ] ;
	[[self navigationController] pushViewController:vardentalMAPDetailsView animated:YES];
	[vardentalMAPDetailsView release] ;
