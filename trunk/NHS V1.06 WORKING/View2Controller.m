...
-(IBAction)DentalButton{
	...
	UIAlertView * alert =	[[UIAlertView alloc] initWithTitle:@"NHS Bristol: Dentist" message:@"To find a dentist accepting NHS patients, call the NHS Bristol Dental Helpline on: 0845 120 6680. The line is open between 9 a.m. and 6 p.m. Monday to Fridays." delegate:self cancelButtonTitle:@"Cancel" otherButtonTitles:@"Continue", nil];
...
-(IBAction)AandE999Button{
	// open a alert with an OK and cancel button
 	...
 	UIAlertView * alert =	[[UIAlertView alloc] initWithTitle:@"NHS Bristol: Is it a critical situation?" message:@"A critital situation can include: unconsciousness, a suspected stroke, heavy blood loss, a deep wound such as a stab wound, a suspected heart attack, difficulty in breathing or severe burns." delegate:self cancelButtonTitle:@"Cancel" otherButtonTitles:@"Continue", nil];
