...
$config['email_recipient'] = 'franz@pub-highlander.de';
$config['email_recipient_cc'] = '';
$config['email_sender'] = 'Dartligaverwaltung';
...
$databases['db_actual'] = 'usr_web363_1';
