...
-(IBAction) buttonAlarmTurnAction{
	...
	if ( alarmaSonando ){
		...
		UIAlertView * alert =	[[UIAlertView alloc] initWithTitle:@"NHS Yorkshire and Humber: Emergency" message:@"Are you sure you want to turn the alarm off?" delegate:self cancelButtonTitle:@"Cancel" otherButtonTitles:@"Continue", nil];
		[alert show];
		[alert release];
...
- (void)viewDidLoad {
	...
	if(mostrarAlerta){
		...
		NSLog(@"ALERTA!!") ;
		volver = TRUE ;
		UIAlertView * alert =	[[UIAlertView alloc] initWithTitle:@"NHS Yorkshire and Humber: Emergency" message:@"You need to set your information in the Settings (Personal menu) before turning on the Alarm." delegate:self cancelButtonTitle:@"Ok" otherButtonTitles: nil];
		[alert show];
		[alert release];
...
- (IBAction)sendSMS{
	...
	if( latitudeFLOAT == -180.000000 ){
		...
		UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"NHS Yorkshire and Humber" message: @"We didn't found your GPS position. Please check your connection." delegate:self cancelButtonTitle:@"OK" otherButtonTitles: nil];
...
- (void)reverseGeocoder:(MKReverseGeocoder *)geocoder didFindPlacemark:(MKPlacemark *)placemark
{
	...
	header = @"NHS Yorkshire and Humber: This is an emergency message. My position: " ;
	...
	email = [NSString stringWithFormat: @"%@%@%@" ,  @"mailto:" , mailNextkin, @"?Subject=NHS Yorkshire and Humber: Help me!&body=" ] ;
...
-(IBAction)call999{
	UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Emergency" message:@"Are you sure you want to call 999 emergencies?"
